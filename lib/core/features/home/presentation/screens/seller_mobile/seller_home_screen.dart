    ...
    return Scaffold(
                                ...
                                child: DataTable(
                                  border: TableBorder(
                                    horizontalInside: BorderSide(
                                      color: secondryTextColor.withOpacity(.5),
                                    ),
                                  ...
                                  headingRowColor: WidgetStateProperty.all(
                                      primaryColorCode.withOpacity(.2)),
                                  ...
                                  columns: const [
                                    DataColumn(
                                      label: Text(
                                        "Name",
                                        style:
                                            TextStyle(color: primaryColorCode),
                                      ),
                                    ),
                                    DataColumn(
                                      label: Text(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => SellerCreateStep1Screen()),
          );
        },
        icon: Icon(
          Icons.add,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
              "This is group where all highly motivated UPSC aspirants get motivation from."),
          SizedBox(
            height: 20,
          ),
          Row(
