...
import 'package:v_library/core/features/home/presentation/screens/live_course/course_create/step_4_additional.dart';
import 'package:v_library/core/utils/colors.dart';

class RecordStepFourScreen2 extends StatefulWidget {
  const RecordStepFourScreen2({super.key});
...
class _StepFourScreenState extends State<RecordStepFourScreen2> {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => StepFourAdditionalScreen()),
                      );
                    },
