...
import 'package:v_library/core/features/home/presentation/screens/live_course/course_create/step_4_screen_2.dart';
import 'package:v_library/core/features/home/presentation/screens/record_course/course_create/step_4_screen_2.dart';
import 'package:v_library/core/utils/colors.dart';

class RecordStepFourScreen extends StatefulWidget {
  const RecordStepFourScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _RecordStepFourScreenState createState() => _RecordStepFourScreenState();
}

class _RecordStepFourScreenState extends State<RecordStepFourScreen> {
              ...
              Column(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Transform.scale(
                        scale: 0.8, // Reduce switch size
                        child: Switch(
                          value: isLimitedTimeofferEnabled,
                          onChanged: (value) {
                            setState(() {
                              isLimitedTimeofferEnabled = value;
                            });
                          },
                          activeColor: const Color(0xFF2D68FE), // Hex #2D68FE
                        ),
                  ...
                  TextField(
                    readOnly: true,
                    decoration: InputDecoration(
                      hintText: isLimitedTimeofferEnabled
                          ? "Select date"
                          : "Date drop down if turned on",
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(8),
                      ...
                      suffixIcon: isLimitedTimeofferEnabled
                          ? IconButton(
                              icon: const Icon(Icons.calendar_today),
                              onPressed: () async {
                                final DateTime? pickedDate =
                    ...
                    enabled: isLimitedTimeofferEnabled,
                  ),
                  const SizedBox(height: 5), // Chhota gap before small text
                  const Text(
                    "Your selling price will be: (calculate price)",
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RecordStepFourScreen2()),
                      );
                    },
