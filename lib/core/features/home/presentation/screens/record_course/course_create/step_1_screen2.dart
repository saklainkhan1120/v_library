...
import 'package:v_library/core/features/home/presentation/screens/record_course/course_create/step_2_screen.dart';
import 'package:v_library/core/utils/colors.dart';

class RecordStepOneScreentwo extends StatefulWidget {
  const RecordStepOneScreentwo({super.key});

  @override
  _StepOneScreenState createState() => _StepOneScreenState();
}

class _StepOneScreenState extends State<RecordStepOneScreentwo> {
  int currentStep = 1;
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RecordStepTwoScreen()),
                      );
                    },
