...
import 'package:v_library/core/features/home/presentation/screens/live_course/course_create/step_4_additional_2.dart';
import 'package:v_library/core/utils/colors.dart';

class RecordStepFourAdditionalScreen extends StatefulWidget {
  const RecordStepFourAdditionalScreen({super.key});
...
class _StepFourScreenState extends State<RecordStepFourAdditionalScreen> {
              ...
              Column(
                ...
                children: [
                  Row(
                    children: [
                      const Text(
                        "Charge extra for a extra month",
                        style: TextStyle(
                            fontSize: 16, fontWeight: FontWeight.bold),
                      ),
                      const Spacer(),
