...
class LiveStepOneScreen extends StatefulWidget {
  const LiveStepOneScreen({super.key});

  @override
  _LiveStepOneScreenState createState() => _LiveStepOneScreenState();
}

class _LiveStepOneScreenState extends State<LiveStepOneScreen> {
  int currentStep = 1;
