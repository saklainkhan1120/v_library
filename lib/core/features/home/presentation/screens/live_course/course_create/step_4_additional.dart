...
class StepFourAdditionalScreen extends StatefulWidget {
  const StepFourAdditionalScreen({super.key});
...
class _StepFourScreenState extends State<StepFourAdditionalScreen> {
